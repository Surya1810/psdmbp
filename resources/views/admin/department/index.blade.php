...
@section('content')
                ...
                <div class="col-12">
                    <div class="card card-outline rounded-partner card-warning">
                        ...
                        <div class="card-body table-responsive">
                            <table id="DepartmentTable" class="table table-bordered text-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-warning rounded-partner"
                                                    data-toggle="modal" data-target="#editDepartment{{ $data->id }}">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </button>
                                                <button class="btn btn-sm btn-danger rounded-partner"
                                                    onclick="deleteDepartment({{ $data->id }})"><i
                                                        class="fas fa-trash"></i></button>
                                                <form id="delete-form-{{ $data->id }}"
                                                    action="{{ route('department.destroy', $data->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
    ...
    @foreach ($departments as $data)
        <div class="modal fade" id="editDepartment{{ $data->id }}" tabindex="-1" aria-labelledby="editDepartmentLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
