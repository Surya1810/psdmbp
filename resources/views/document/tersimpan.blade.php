...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Dokumen Tersimpan</h1>
                    <ol class="breadcrumb text-black-50">
                        <li class="breadcrumb-item"><a class="text-warning" href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active"><strong>Dokumen Tersimpan</strong></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-outline rounded-partner card-warning">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h3 class="card-title">Dokumen Tersimpan</h3>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success rounded-partner"
                                                    onclick="Selesai({{ $data->id }})">Selesai</button>
                                                ...
                                                <button class="btn btn-sm btn-danger rounded-partner"
                                                    onclick="Batal({{ $data->id }})">Batal</button>
                                                <form id="delete-form-{{ $data->id }}"
                                                    action="{{ route('user.destroy', $data->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
